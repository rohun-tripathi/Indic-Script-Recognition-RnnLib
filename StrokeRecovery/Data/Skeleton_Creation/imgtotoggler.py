	...
	for index1, subfolder in enumerate(distribution):
		...
		for index2, subsubfol in enumerate(dirnames):
			...
			for onefile in filenames:
				...
				if not ".bmp" in filepath and not ".tiff" in filepath:
					#Not an image file
					continue
				fileNo += 1
				outpath = "ToggledDATA/" + "black" +  folder.strip("Off") + "/file" + str(index1) + "_" + str(index2) + "_" + str(fileNo) + ".tiff"
